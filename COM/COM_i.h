...
#ifndef __IFirstComObj_FWD_DEFINED__
#define __IFirstComObj_FWD_DEFINED__
typedef interface IFirstComObj IFirstComObj;

#endif 	/* __IFirstComObj_FWD_DEFINED__ */
...
#ifndef __FirstComObj_FWD_DEFINED__
#define __FirstComObj_FWD_DEFINED__

#ifdef __cplusplus
typedef class FirstComObj FirstComObj;
#else
typedef struct FirstComObj FirstComObj;
#endif /* __cplusplus */

#endif 	/* __FirstComObj_FWD_DEFINED__ */
...
#ifndef __IFirstComObj_INTERFACE_DEFINED__
#define __IFirstComObj_INTERFACE_DEFINED__

/* interface IFirstComObj */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IFirstComObj;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("f445d071-6f53-48df-ab47-1d3d274ecd00")
    IFirstComObj : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE AddOne_COM( 
            /* [in] */ LONG a,
    ...
    typedef struct IFirstComObjVtbl
    {
        BEGIN_INTERFACE
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *AddOne_COM )( 
            IFirstComObj * This,
            /* [in] */ LONG a,
    ...
    interface IFirstComObj
    {
        CONST_VTBL struct IFirstComObjVtbl *lpVtbl;
    };
...
#define IFirstComObj_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IFirstComObj_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IFirstComObj_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IFirstComObj_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IFirstComObj_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IFirstComObj_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IFirstComObj_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IFirstComObj_AddOne_COM(This,a,result)	\
    ( (This)->lpVtbl -> AddOne_COM(This,a,result) ) 
...
#endif 	/* __IFirstComObj_INTERFACE_DEFINED__ */
...
class DECLSPEC_UUID("d55bbe1f-79f9-4b9a-aa92-d6447b426e12")
CompReg;
#endif

EXTERN_C const CLSID CLSID_FirstComObj;

#ifdef __cplusplus

class DECLSPEC_UUID("fd612505-5c08-4a68-82ba-a9e67cc31b2a")
FirstComObj;
#endif
