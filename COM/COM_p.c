...
extern const MIDL_SERVER_INFO IFirstComObj_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFirstComObj_ProxyInfo;
...
/* Object interface: IFirstComObj, ver. 0.0,
   GUID={0xf445d071,0x6f53,0x48df,{0xab,0x47,0x1d,0x3d,0x27,0x4e,0xcd,0x00}} */

#pragma code_seg(".orpc")
static const unsigned short IFirstComObj_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IFirstComObj_ProxyInfo =
    {
    &Object_StubDesc,
    COM__MIDL_ProcFormatString.Format,
    &IFirstComObj_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFirstComObj_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    COM__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IFirstComObjProxyVtbl = 
{
    &IFirstComObj_ProxyInfo,
    &IID_IFirstComObj,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IFirstComObj::AddOne_COM */
};


static const PRPC_STUB_FUNCTION IFirstComObj_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IFirstComObjStubVtbl =
{
    &IID_IFirstComObj,
    &IFirstComObj_ServerInfo,
    8,
    &IFirstComObj_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
{
    ( CInterfaceProxyVtbl *) &_IFirstComObjProxyVtbl,
...
int __stdcall _COM_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _COM, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _COM, 2, *pIndex )
